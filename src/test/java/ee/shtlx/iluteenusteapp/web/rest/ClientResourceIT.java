...
public class ClientResourceIT {
    private static final Boolean DEFAULT_IS_SHOP_OWNER = false;
    private static final Boolean UPDATED_IS_SHOP_OWNER = true;
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client().isShopOwner(DEFAULT_IS_SHOP_OWNER).tel(DEFAULT_TEL);
        return client;
    }
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client().isShopOwner(UPDATED_IS_SHOP_OWNER).tel(UPDATED_TEL);
        return client;
    }
    ...
    public void createClient() throws Exception {
        ...
        assertThat(testClient.isIsShopOwner()).isEqualTo(DEFAULT_IS_SHOP_OWNER);
    ...
    @Test
    @Transactional
    public void checkIsShopOwnerIsRequired() throws Exception {
        int databaseSizeBeforeTest = clientRepository.findAll().size();
        // set the field null
        client.setIsShopOwner(null);
    ...
    public void getAllClients() throws Exception {
        ...
        restClientMockMvc
            ...
            .andExpect(jsonPath("$.[*].isShopOwner").value(hasItem(DEFAULT_IS_SHOP_OWNER.booleanValue())))
    ...
    public void getClient() throws Exception {
        ...
        restClientMockMvc
            ...
            .andExpect(jsonPath("$.isShopOwner").value(DEFAULT_IS_SHOP_OWNER.booleanValue()))
    ...
    public void updateClient() throws Exception {
        ...
        updatedClient.isShopOwner(UPDATED_IS_SHOP_OWNER).tel(UPDATED_TEL);
        ...
        Client testClient = clientList.get(clientList.size() - 1);
        assertThat(testClient.isIsShopOwner()).isEqualTo(UPDATED_IS_SHOP_OWNER);
